...
scp ${CHAMPSIM}/data/bp_models/2_bit/${BIN_FILE} bp1-copy:/user/work/eh19257/data/bp_models/2_bit/
...
scp ${CHAMPSIM}/data/bp_models/AT/${BIN_FILE} bp1-copy:/user/work/eh19257/data/bp_models/AT/
...
scp ${CHAMPSIM}/data/bp_models/BT_FNT/${BIN_FILE} bp1-copy:/user/work/eh19257/data/bp_models/BT_FNT/
...
scp ${CHAMPSIM}/data/bp_models/gshare/${BIN_FILE} bp1-copy:/user/work/eh19257/data/bp_models/gshare/
...
scp ${CHAMPSIM}/data/bp_models/NT/${BIN_FILE} bp1-copy:/user/work/eh19257/data/bp_models/NT/
...
scp ${CHAMPSIM}/data/bp_models/perceptron/${BIN_FILE} bp1-copy:/user/work/eh19257/data/bp_models/perceptron/
