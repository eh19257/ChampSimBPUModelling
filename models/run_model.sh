...
#SBATCH -o ./outputs/lr0.001SGD_mod_16/log_%j.out
#SBATCH -e ./outputs/lr0.001SGD_mod_16/log_%j.err
...
python3 2_bit_model_tf_transformer.py ../../data/bp_models/2_bit/pwd.bin ../../data/bp_models/2_bit/ls.bin .outputs/lr0.001SGD_mod_16/SAVED_MODEL