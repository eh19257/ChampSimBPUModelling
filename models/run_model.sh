...
#SBATCH --job-name 0.01m16
#SBATCH --partition gpu
#SBATCH --nodes 1
#SBATCH --gres gpu:0,gpu:1,gpu:2
#SBATCH --mem 64GB
#SBATCH --account=COSC027924
#SBATCH -o ./outputs/lr0.01SGD_mod_16/log_%j.out
#SBATCH -e ./outputs/lr0.01SGD_mod_16/log_%j.err
...
python3 2_bit_model_tf_transformer.py ../../data/bp_models/2_bit/pwd.bin ../../data/bp_models/2_bit/ls.bin .outputs/lr0.01SGD_mod_16/SAVED_MODEL