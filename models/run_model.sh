...
#SBATCH -o ./outputs/lr0.01pwd_test/log_%j.out
#SBATCH -e ./outputs/lr0.01pwd_test/log_%j.err
...
python3 2_bit_model_tf_transformer.py ../../data/bp_models/2_bit/pwd.bin ../../data/bp_models/2_bit/ls.bin .outputs/lr0.01pwd_test/SAVED_MODEL